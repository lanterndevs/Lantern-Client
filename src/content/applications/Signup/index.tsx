...
const validationSchema = yup.object({
  ...
  firstName: yup
    ...
    .matches(/^[a-zA-Z0-9]+$/, 'First name has non-alphanumeric characters'),
  lastName: yup
    .string()
    .required('Last name is required')
    .matches(/^[a-zA-Z0-9]+$/, 'Last name has non-alphanumeric characters'),
  organization: yup
    .string()
    .required('Organization name is required')
    .matches(
      /^[a-zA-Z0-9]+$/,
      'Organization name has non-alphanumeric characters'
    )
});
